...
class Controller:
    ...
    def add_player(self, player_type: str, username: str):
        ...
        return f"Successfully added card of type {player_type}Card with name: {username}"
    ...
    def report(self):
        ...
        for player in self.player_repository.players:
            result += f"{player.username} - Health: {player.health} - Cards {player.card_repository.count}\n"
